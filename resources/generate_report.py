...
bl = ParagraphStyle("bl", fontName=FONT_NAME, fontSize=10.5, leading=16, leftIndent=8*mm, spaceBefore=1*mm, spaceAfter=1*mm)
...
def build():
    ...
    story.append(RLImage(diags["uc"], width=170*mm, height=108*mm))
    story.append(Paragraph("Fig 1: Use Case Diagram", cp))
    story.append(PageBreak())
    story.append(Paragraph("3. Class Diagram", h1))
    story.append(RLImage(diags["cls"], width=170*mm, height=115*mm))
    ...
    story.append(RLImage(diags["seq"], width=170*mm, height=120*mm))
    story.append(Paragraph("Fig 3: Sequence Diagram", cp))
    story.append(PageBreak())
    story.append(Paragraph("5. Activity Diagram", h1))
    story.append(RLImage(diags["act"], width=150*mm, height=160*mm))
    ...
    story.append(RLImage(diags["menu"], width=130*mm, height=85*mm))
    story.append(Paragraph("Fig 5: Main Menu", cp))
    story.append(Spacer(1,5*mm))
    story.append(RLImage(diags["game"], width=105*mm, height=90*mm))
